...
class SensorPublish
{
	public:
		SensorPublish(){
			coneX_pub = n.advertise<std_msgs::Float64MultiArray>("coneX", 1000);
			coneP_pub = n.advertise<std_msgs::Float64MultiArray>("coneP", 1000);
			sub = n.subscribe("cmd_vel",1000,&SensorPublish::Callback,this);
		} 
	...
	private:
		ros::NodeHandle n;
		ros::Publisher coneX_pub;
		ros::Publisher coneP_pub;
		ros::Subscriber sub;
};
*/
